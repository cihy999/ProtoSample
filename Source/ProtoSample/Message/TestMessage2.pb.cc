...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_TestMessage2_2eproto_getter() {
  return &descriptor_table_TestMessage2_2eproto;
}
...
::PROTOBUF_NAMESPACE_ID::Metadata TestMessage2::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_TestMessage2_2eproto_getter, &descriptor_table_TestMessage2_2eproto_once,
      file_level_metadata_TestMessage2_2eproto[0]);
}
